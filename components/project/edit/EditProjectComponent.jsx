...
export default function EditProjectComponent({ project: initialProject }) {
    ...
    const isAnyTaskInProgress = () => {
        return project?.data?.tasks?.validation?.length > 0 ?? false;
    };
            ...
            <div className="flex-none border-b border-gray-200 bg-white px-2 py-2 sm:px-6 sm:py-5 flex items-center justify-between">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                        ...
                        {isAnyTaskInProgress() && (
                            <svg className="animate-spin h-6 w-6 sm:h-4 sm:w-4 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
