...
const createValidationService = () => {
    ...
    const processAsyncValidation = async (log, projectId, analysisData) => {
        ...
        const summary = await generateSummary(log, projectId, {
            competitorAnalysis,
            ...analysisData
        });
        await generateOptimizations(log, projectId, {
            userInput: analysisData.userInput,
            hww: analysisData.hww,
            tamSamSom: analysisData.tamSamSom,
            competitorAnalysis,
            summary
        });
    };
