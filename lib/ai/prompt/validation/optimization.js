...
- Problem Optimization Suggestions:
    ...
    - Each variation should be returned in the following structure:
        ...
        - user_input: Modified version of original input with:
            ...
            - targetRevenue: Revenue strategy (minimum 3-4 sentences) including:
                - Detailed revenue streams with percentages
                - Pricing strategy with specific tiers
                - Customer acquisition costs with numbers
                - Customer lifetime value calculations
                - Break-even analysis with timeline
                - Profit margins by product/service
                - Operating costs breakdown
                - Marketing budget with allocation
                - Sales projections with growth rates
                - Growth metrics with KPIs
            - Keep original:
                - language
                - currency
                - personalConstraints
