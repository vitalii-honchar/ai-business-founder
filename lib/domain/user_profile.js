...
export class Usage {
    ...
    constructor({
        ...
        this.validationsPerProject = validationsPerProject ?? {};
    }
    ...
    increaseValidationsPerProject(projectId) {
        this.validationsPerProject[projectId] = (this.validationsPerProject[projectId] ?? 0) + 1;
    }

    getValidationsPerProject(projectId) {
        return this.validationsPerProject[projectId] ?? 0;
    }
}
...
export class UserProfile {
    ...
    isMaxProjectsReached() {
        return this.usage.maxProjects >= this.maxProjects;
    }

    isMaxValidationsPerProjectReached(projectId) {
        return this.usage.getValidationsPerProject(projectId) >= this.maxValidationsPerProject;
    }
